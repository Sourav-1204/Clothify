...
import { mergeCart } from "../features/cart/cartThunk";
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
        ...
        >
          <div className="flex justify-center mb-6">
            <h2 className="text-xl font-medium">E-DUKAAN</h2>
          </div>
          ...
          >
            {loading ? <AiOutlineLoading3Quarters className="animate-spin text-white mx-auto size-5"/>: "Sign In"}
          </button>
